...
const printNavbar = () => {
  ...
  domString += '<a href="src/index.html" class="logo-img"><img src="src/javascripts/components/navbar/Logo-Images/clapback_overlay.gif" id="logo"></a>';
  domString += '</div>';
  ...
  domString += '<div id="customThemeModal"></div>';
  domString += '</form>';
  domString += '</div>';
  domString += '</div>';
